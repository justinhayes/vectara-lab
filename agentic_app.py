...
vec_factory = VectaraToolFactory(
    vectara_api_key='zut_AZu6xtTvx-gH8tv1yr_tvgF6Jt7FAroYf1ZIaw',
    #vectara_customer_id='26983110',
    vectara_corpus_key='justin_01-getting-started-query-api'
)
...
class QueryShakespeareArgs(BaseModel):
    ...
    #type: str = Field(..., description="Indicates the type of the entity being searched. Should be 'meeting'.")
...
def run_query(query: str):
    ...
    private_llm_config = AgentConfig(
        ...
        private_llm_api_key="<ENTER HERE>"
    )
